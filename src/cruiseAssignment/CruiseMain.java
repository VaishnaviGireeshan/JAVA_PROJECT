...
public class CruiseMain {
	...
	public static void main(String[] args) {
		...
		if (selectedCruise != null) {
			...
			System.out.println("Price for Adults (greater than 12)   : " + selectedCruise.adultPrice + " per day ");
			System.out.println("Price for Kids (Above 5)             : " + selectedCruise.childPrice + " per day ");
			...
			double totalPrice = priceCalculator.calculateTotalPrice(ticketPrice, adultMealPrice, childMealPrice);
